...
const gettext = (msg) => (
    TRANSLATE ? jedTranslated.gettext(msg) : jedEmpty.gettext(msg)
);
...
export const TestComponent = ({translate}) => {
    ...
    return (
        <div>
            ...
            <br />
            <span title={title}><Translate>Hover me</Translate></span>
            <br />
            <Translate>
                &lt;HTML&gt;
                is unescaped when extracted
            </Translate>
            <br />
            <Translate>
                xxx
                foo bar
                <Param name="test" value={1} /><Param name="x" value={'2'}> y</Param>{' '}
                moo
            </Translate>
            <hr />
            <Translate>
